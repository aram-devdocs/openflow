/**
 * Aside primitive utility function tests
 *
...
/**
 * Re-implement the Aside utility functions for testing
 * (mirrors the logic in Aside.tsx)
 */
...
function extractSpacingClasses(props: AsideSpacingProps): string[] {
  const classes: string[] = [];
...
describe('primitives/Aside - Utility Functions', () => {
  ...
  describe('Aside component requirements', () => {
    it('aria-label is optional (like Nav and Article)', () => {
      // This test documents that Aside does NOT require aria-label
      // The AsideProps interface makes aria-label optional via A11yProps
      const optionalProps = ['aria-label'];
      expect(optionalProps).toContain('aria-label');
    });

    it('renders as an aside element', () => {
      // This test documents that Aside always renders as <aside>
      // Unlike Box, Aside is not polymorphic
      const element = 'aside';
      expect(element).toBe('aside');
    });

    it('is for complementary content', () => {
      // This test documents the semantic purpose of Aside
      const validUseCases = [
        'sidebar',
        'pull quote',
        'advertising',
  ...
  describe('Aside spacing scenarios', () => {
    it('generates classes for sidebar pattern', () => {
      const classes = extractSpacingClasses({
        p: { base: '4', lg: '6' },
        gap: '4',
      });
    ...
    it('generates classes for table of contents pattern', () => {
      const classes = extractSpacingClasses({
        p: '4',
        pl: '6',
      });
    ...
    it('generates classes for pull quote pattern', () => {
      const classes = extractSpacingClasses({
        py: '4',
        pl: '6',
        my: '8',
    ...
    it('generates classes for sticky sidebar pattern', () => {
      const classes = extractSpacingClasses({
        p: { base: '4', md: '6' },
        pt: '0',
      });
    ...
    it('generates classes for author bio pattern', () => {
      const classes = extractSpacingClasses({
        p: '6',
        mt: '8',
        mb: '4',
  ...
  describe('Aside vs other landmarks comparison', () => {
    it('Aside is for complementary content', () => {
      // Aside: tangentially related content
      const asideCharacteristics = [
        'complementary content',
        'tangentially related',
        'can be removed without affecting main content',
        'sidebars and pull quotes',
      ];
      expect(asideCharacteristics).toContain('complementary content');
    });

    it('Nav is for navigation', () => {
  ...
  describe('ARIA attribute support', () => {
    it('supports aria-label for labeling', () => {
      // Aside supports optional aria-label
