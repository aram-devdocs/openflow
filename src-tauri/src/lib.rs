...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_agent_session_with_state,
            commands::get_agent_session_summary,
            commands::list_agent_sessions_by_process,
            commands::list_running_agent_sessions,
            commands::get_agent_session_events,
            ...
            commands::recover_stale_agent_sessions,
            // Chat commands
            commands::list_chats,
