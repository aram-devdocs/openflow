...
// Message Block Classes (CLI-style)
MESSAGE_BLOCK_CLASSES = "${MESSAGE_BLOCK_CLASSES}"
MESSAGE_HEADER_CLASSES = "${MESSAGE_HEADER_CLASSES}"
MESSAGE_CONTENT_CLASSES = "${MESSAGE_CONTENT_CLASSES}"
