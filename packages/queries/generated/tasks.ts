...
export async function archiveTask(id: string): Promise<Task> {
  ...
  try {
    ...
    logger.info('archive_task completed', { id: (result as Record<string, unknown>).id });
...
export async function createTask(request: CreateTaskRequest): Promise<Task> {
  ...
  try {
    ...
    logger.info('create_task completed', { id: (result as Record<string, unknown>).id });
...
export async function duplicateTask(id: string): Promise<Task> {
  ...
  try {
    ...
    logger.info('duplicate_task completed', { id: (result as Record<string, unknown>).id });
...
export async function getTask(id: string): Promise<TaskWithChats> {
  ...
  try {
    ...
    logger.info('get_task completed', { id: (result as Record<string, unknown>).id });
 ...
 * @param includeArchived - Query parameter: include_archived (optional)
 * @returns Promise resolving to Task[]
 * @throws Error if validation or query fails
 */
...
export async function unarchiveTask(id: string): Promise<Task> {
  ...
  try {
    ...
    logger.info('unarchive_task completed', { id: (result as Record<string, unknown>).id });
...
export async function updateTask(id: string, request: UpdateTaskRequest): Promise<Task> {
  ...
  try {
    ...
    logger.info('update_task completed', { id: (result as Record<string, unknown>).id });
