...
export async function archiveTask(id: string): Promise<Task> {
  ...
  try {
    ...
    logger.info('archive_task completed', { id: (result as unknown as Record<string, unknown>).id });
...
export async function duplicateTask(id: string): Promise<Task> {
  ...
  try {
    ...
    logger.info('duplicate_task completed', { id: (result as unknown as Record<string, unknown>).id });
...
export async function listTasks(projectId?: string, includeArchived?: string): Promise<Task[]> {
  ...
  try {
    const result = await invoke<Task[]>('list_tasks', { projectId: projectId, includeArchived: includeArchived });
...
export async function unarchiveTask(id: string): Promise<Task> {
  ...
  try {
    ...
    logger.info('unarchive_task completed', { id: (result as unknown as Record<string, unknown>).id });
