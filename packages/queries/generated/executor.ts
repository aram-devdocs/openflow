...
// Domain: executor
// Generated at: 2026-01-02T06:27:35.448Z
//
...
export async function getExecutorProfile(id: string): Promise<ExecutorProfile> {
  ...
  try {
    ...
    logger.info('get_executor_profile completed', { id: (result as Record<string, unknown>).id });
...
export async function runExecutor(request: RunExecutorRequest): Promise<ExecutionProcess> {
  ...
  try {
    ...
    logger.info('run_executor completed', { id: (result as Record<string, unknown>).id });
