...
export async function appendMessageContent(id: string, request: AppendMessageContentRequest): Promise<Message> {
  ...
  try {
    ...
    logger.info('append_message_content completed', { id: (result as Record<string, unknown>).id });
...
export async function createMessage(request: CreateMessageRequest): Promise<Message> {
  ...
  try {
    ...
    logger.info('create_message completed', { id: (result as Record<string, unknown>).id });
...
export async function getMessage(id: string): Promise<Message> {
  ...
  try {
    ...
    logger.info('get_message completed', { id: (result as Record<string, unknown>).id });
...
export async function setMessageStreaming(id: string, request: SetMessageStreamingRequest): Promise<Message> {
  ...
  try {
    ...
    logger.info('set_message_streaming completed', { id: (result as Record<string, unknown>).id });
