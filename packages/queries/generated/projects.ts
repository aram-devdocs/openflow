...
export async function archiveProject(id: string): Promise<Project> {
  ...
  try {
    ...
    logger.info('archive_project completed', { id: (result as Record<string, unknown>).id });
...
export async function createProject(request: CreateProjectRequest): Promise<Project> {
  ...
  try {
    ...
    logger.info('create_project completed', { id: (result as Record<string, unknown>).id });
...
export async function getProject(id: string): Promise<Project> {
  ...
  try {
    ...
    logger.info('get_project completed', { id: (result as Record<string, unknown>).id });
...
export async function unarchiveProject(id: string): Promise<Project> {
  ...
  try {
    ...
    logger.info('unarchive_project completed', { id: (result as Record<string, unknown>).id });
...
export async function updateProject(id: string, request: UpdateProjectRequest): Promise<Project> {
  ...
  try {
    ...
    logger.info('update_project completed', { id: (result as Record<string, unknown>).id });
