...
export async function createWorktree(request: CreateWorktreeRequest): Promise<Worktree> {
  ...
  try {
    ...
    logger.info('create_worktree completed', { id: (result as unknown as Record<string, unknown>).id });
 ...
 * @command get_commits
 * @param worktreePath - Query parameter: worktreePath (optional)
 * @param limit - Query parameter: limit (optional)
 * @param baseRef - Query parameter: baseRef (optional)
...
export async function getCommits(worktreePath?: string, limit?: string, baseRef?: string): Promise<Commit[]> {
  ...
  try {
    const result = await invoke<Commit[]>('get_commits', { worktreePath: worktreePath, limit: limit, baseRef: baseRef });
 ...
 * @param repoPath - Query parameter: repoPath (optional)
...
export async function getCurrentBranch(repoPath?: string): Promise<string> {
  ...
  try {
    const result = await invoke<string>('get_current_branch', { repoPath: repoPath });
...
export async function getDiff(worktreePath?: string, baseRef?: string): Promise<FileDiff[]> {
  ...
  try {
    const result = await invoke<FileDiff[]>('get_diff', { worktreePath: worktreePath, baseRef: baseRef });
...
export async function getHeadCommit(repoPath?: string): Promise<string> {
  ...
  try {
    const result = await invoke<string>('get_head_commit', { repoPath: repoPath });
...
export async function hasUncommittedChanges(repoPath?: string): Promise<boolean> {
  ...
  try {
    const result = await invoke<boolean>('has_uncommitted_changes', { repoPath: repoPath });
...
export async function listWorktrees(repoPath?: string): Promise<Worktree[]> {
  ...
  try {
    const result = await invoke<Worktree[]>('list_worktrees', { repoPath: repoPath });
