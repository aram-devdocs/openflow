...
// Generated at: 2026-01-06T04:36:17.428Z
//
...
export const COMMAND_MAP: Readonly<Record<string, EndpointMapping>> = {
  ...
  artifact_read: {
    ...
    pathParams: ['taskId', 'fileName'] as const,
    queryParams: [] as const,
    hasRequestBody: false,
    responseType: 'string',
  },
  ...
  artifacts_list: {
    ...
    pathParams: ['taskId'] as const,
    queryParams: [] as const,
    hasRequestBody: false,
    responseType: 'ArtifactFile[]',
  },
  ...
  check_gh_cli_installed: {
    ...
    queryParams: [] as const,
    hasRequestBody: false,
    responseType: 'CliInstalledResponse',
  },
  /** Create a new chat */
  create_chat: {
    method: 'POST',
  ...
  get_agent_session_events: {
    ...
    pathParams: ['id'] as const,
    queryParams: ['afterSequence'] as const,
    hasRequestBody: false,
    responseType: 'AgentEventRecord[]',
  },
  ...
  get_agent_session_with_state: {
    method: 'GET',
    path: '/api/agents/sessions/:id/with-state',
    pathParams: ['id'] as const,
    queryParams: [] as const,
    hasRequestBody: false,
    responseType: 'AgentSessionWithState',
  },
  /** Get all settings */
  get_all_settings: {
    method: 'GET',
  ...
  get_commits: {
    ...
    pathParams: [] as const,
    queryParams: ['worktreePath', 'limit', 'baseRef'] as const,
    hasRequestBody: false,
    responseType: 'Commit[]',
  },
  ...
  get_diff: {
    ...
    path: '/api/git/diff',
    pathParams: [] as const,
    queryParams: ['worktreePath', 'baseRef'] as const,
    hasRequestBody: false,
  ...
  /** Get a snapshot of process output buffer */
  ...
  get_setting_or_default: {
    ...
    pathParams: ['key'] as const,
    queryParams: ['defaultValue'] as const,
    hasRequestBody: false,
    responseType: 'string',
  },
  ...
  list_agent_sessions_by_process: {
    method: 'GET',
    path: '/api/agents/sessions/by-process/:processId',
    pathParams: ['processId'] as const,
    queryParams: [] as const,
    hasRequestBody: false,
    responseType: 'AgentSession[]',
  },
  ...
  list_chats_by_project: {
    ...
    pathParams: [] as const,
    queryParams: ['projectId'] as const,
    hasRequestBody: false,
    responseType: 'Chat[]',
  },
  ...
  list_tasks: {
    ...
    path: '/api/tasks',
    pathParams: [] as const,
    queryParams: ['projectId', 'includeArchived'] as const,
    hasRequestBody: false,
    responseType: 'Task[]',
  },
  ...
  search: {
    ...
    path: '/api/search',
    pathParams: [] as const,
    queryParams: ['query', 'projectId'] as const,
    hasRequestBody: false,
  ...
  set_message_tokens: {
    ...
    pathParams: ['id'] as const,
    queryParams: ['inputTokens', 'outputTokens'] as const,
    hasRequestBody: false,
    responseType: 'Message',
  },
  /** Set a setting value */
